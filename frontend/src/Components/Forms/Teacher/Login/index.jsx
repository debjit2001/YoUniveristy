...
import { validateEmail, validatePassword, validateRegistrationNumber } from '../../../Validators/validate';
...
const Login=()=>{
  ...
  const [teacherLogin,setTeacherLogin]=useState({registrationNumber:'',email:'',password:''})
  let name,value;
  var error=false;
  ...
  return(
    ...
    <div className={`${styles.form_row}`}>
      ...
      <div className={`${styles.form_name}`} id="registrationNumber">    
