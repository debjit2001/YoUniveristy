  ...
  const rightmove = () => {
    ...
    if (
      ...
      for (var i = 0; i < fields.length; i++) {
        ...
        nameField.style.borderBottom = "2px solid red";
        errorMessage.innerHTML = `${
          fields[i].charAt(0).toUpperCase() + fields[i].substring(1)
        } field is empty`;
      }
      errorCheck.innerHTML = "Kindly fill all the fields";
    } else if (
      !validateName(studentData.studentName)[0] ||
      !validateRoll(studentData.roll)[0] ||
      !validateStream(studentData.stream) ||
      !validateSemester(studentData.semester)
    ) {
